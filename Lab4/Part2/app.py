...
if uploaded_file:
    with tempfile.NamedTemporaryFile(mode="wb+", delete=False) as temp_file:
        ...
        # the code below is my fix to what ever is failing in the above commented code
        # not sure what is going on but the code below fixes it
        # initial error had something to do with langchain.indexes and now the index = ... fails    
        #  load doc
        docs = loader.load()
        ...
        # use hugging face to create the embeddings
